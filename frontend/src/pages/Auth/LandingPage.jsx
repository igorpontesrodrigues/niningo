      ...
      <div style={{
        ...
        <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }}
          ...
          <div className="glass glow" style={{
            ...
            <h3 style={{ fontFamily: 'Cinzel, serif', fontSize: '1.6rem', marginBottom: 12 }}>Inicie sua Jornada</h3>
            <p style={{ color: 'var(--text-muted)', fontSize: '0.9rem', marginBottom: 32, lineHeight: 1.5 }}>
              O teste beta está aberto. Entre usando sua conta do Discord para criar seu ninja e escolher sua vila.
            </p>
